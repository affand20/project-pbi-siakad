	...
	<div class="panel panel-login">
		...
		<hr>
  		<div class="panel-body">
    		<form id="guru" action="prosestambahguru.php" method="post" style="display: block;" role="form">
    			<div class="form-group">
    				<label for="Nama guru">Nama Lengkap</label>
    				<input type="text" class="form-control" placeholder="Nama Lengkap(guru)" name="nama_wali">
    			</div>
    			<div class="form-group">
    				<label for="NIP">NIP</label>
    				<input type="text" class="form-control" placeholder="NIP ex:123456" name="nip">
    			</div>
    			<div class="form-group">
    		...
    		<form id="siswa" action="prosestambahsiswa.php" method="post" style="display: none;" role="form">
    			<div class="form-group">
    				<label for="Nama Guru">Wali Kelas</label>    				
    			...
    			<div class="form-group">
    				...
    				<input type="text" class="form-control" placeholder="Nama Lengkap(siswa)" name="nama_siswa">
    			</div>
    			<div class="form-group">
    				<label for="NIS">NIS</label>
    				<input type="text" class="form-control" placeholder="NIS ex:123456" name="nis">
    			</div>
    			<div class="form-group">
    			<div class="radio">
  					<label>
